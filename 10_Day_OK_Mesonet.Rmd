---
title: "Last 10 days of data for the Madill site from Oklahoma Mesonet"
author: "Mike Proctor"
...
ggplot(madill, aes(TIME, TEMP)) +
  ...
  geom_text(data = temp.floor, aes(label = round(TEMP,0)), hjust = 1.5, color = "blue") +
  geom_text(data = temp.ceiling, aes(label = round(TEMP,0)), hjust = 1.5, color = "red") +
  ggtitle(paste0("High/Low temp values for past 10 days \nStation = Madill","\n", round_date(now(), unit = "minute")))
  ggsave("plots/temp_vals.png", width = 10, height = 8)
print(Temp_vals)
...
ggplot(ppt.rain, aes(TIME, PPT)) +
  ...
  ggsave("plots/ppt_vals.png", width = 10, height = 8)
print(PPT_vals)
```
...
ggplot(madill, aes(TIME, RELH)) +
  ...
  ggtitle(paste0("High/Low RH values for past 10 days \nStation = Madill","\n", round_date(now(), unit = "minute")))
  ggsave("plots/RH.png", width = 10, height = 8)
print(RH_vals)
...
ggplot(one.day, aes(TIME, PRES)) +
  ...
  ggtitle(paste0("24hr Barometric Pressure","\nStation = Madill","\n", round_date(now(), unit = "minute")))
...
pressureTail <- tail(minmaxPressure, 300)
#print(pressureTail)
pressureTail
